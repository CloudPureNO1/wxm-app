...
export const init = () => {
    ...
    // swipe 轮播图片
    const swipeGoods = ref<Array<GoodsType>>([])
    // grid
    ...
    swipeGoods.value = [
        { goodsId: '10001', imgSrc:'https://fastly.jsdelivr.net/npm/@vant/assets/apple-1.jpeg'},
        { goodsId: '10001', imgSrc:'https://fastly.jsdelivr.net/npm/@vant/assets/apple-2.jpeg'},
        { goodsId: '10001', imgSrc:'https://fastly.jsdelivr.net/npm/@vant/assets/apple-3.jpeg'},
    ];
    gridData.value = [
        {
